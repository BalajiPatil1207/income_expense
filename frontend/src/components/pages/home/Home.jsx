      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium">
            Manage your money and see where it goes.
          </p>
        </div>
        <div className="flex gap-3">
          <Link
            to="/dash/income/create"
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl transition-all shadow-md shadow-green-100 font-semibold active:scale-95"
          >
            <PlusCircle size={20} /> Add Income
          </Link>
          <Link
            to="/dash/expense/create"
            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-xl transition-all shadow-md shadow-red-100 font-semibold active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 rounded-2xl flex items-center gap-4">
            ...
            <p className="text-gray-600 text-sm">
              Your income grew by{" "}
              <span className="text-green-600 font-bold">12%</span> this month.
            </p>
          </div>
          <div className="p-4 bg-gray-50 rounded-2xl flex items-center gap-4">
            ...
            <p className="text-gray-600 text-sm">
              Highest spending on{" "}
              <span className="text-red-600 font-bold">Food & Rent</span>.
            </p>
          </div>
        </div>
      </div>
